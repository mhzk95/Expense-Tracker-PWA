    ...
    <div className="relative group shrink-0">
      ...
      <div className="relative z-10">
        <Button
          ...
          size="sm"
          className="gap-1.5 bg-[#facc15] text-black border-2 border-black rounded-lg font-black uppercase tracking-wider shadow-none hover:bg-[#eab308] hover:translate-x-0 hover:translate-y-0"
          style={{ color: '#000' }}
        >
