...
const txParticles = [
  { bg: 'rgba(16, 185, 129, 0.25)', w: 120, h: 120, t: '10%', l: '10%', y: [0, 50, -20, 30, 0], x: [0, 40, -30, 20, 0], d: 35 },
  { bg: 'rgba(59, 130, 246, 0.2)', w: 200, h: 200, t: '60%', l: '70%', y: [0, -60, 40, -30, 0], x: [0, -50, 30, -40, 0], d: 45 },
  { bg: 'rgba(20, 184, 166, 0.2)', w: 150, h: 150, t: '40%', l: '40%', y: [0, -40, 20, -50, 0], x: [0, 60, -20, 40, 0], d: 38 },
  { bg: 'rgba(16, 185, 129, 0.15)', w: 90, h: 90, t: '80%', l: '20%', y: [0, -50, 30, -20, 0], x: [0, 40, -50, 30, 0], d: 30 },
  { bg: 'rgba(59, 130, 246, 0.15)', w: 110, h: 110, t: '20%', l: '80%', y: [0, 60, -40, 50, 0], x: [0, -60, 40, -50, 0], d: 40 },
];

// Research: Deep insight and creativity tones
const researchParticles = [
  { bg: 'rgba(139, 92, 246, 0.25)', w: 150, h: 150, t: '20%', l: '30%', y: [0, 60, -30, 40, 0], x: [0, -40, 50, -30, 0], d: 38 },
  { bg: 'rgba(99, 102, 241, 0.2)', w: 180, h: 180, t: '70%', l: '60%', y: [0, -70, 50, -40, 0], x: [0, 60, -40, 50, 0], d: 42 },
  { bg: 'rgba(217, 70, 239, 0.15)', w: 130, h: 130, t: '40%', l: '80%', y: [0, -50, 30, -60, 0], x: [0, -50, 40, -30, 0], d: 34 },
  { bg: 'rgba(139, 92, 246, 0.2)', w: 100, h: 100, t: '80%', l: '20%', y: [0, -60, 40, -30, 0], x: [0, 50, -30, 40, 0], d: 30 },
];
...
export const AmbientBackground = ({ variant = 'journal' }: { variant?: AmbientVariant }) => {
  const getGradient = () => {
    switch (variant) {
      ...
      case 'research': return "from-violet-900/30 via-slate-950/90 to-slate-950";
      default: return "from-orange-900/20 via-slate-950/90 to-slate-950";
    }
  };
