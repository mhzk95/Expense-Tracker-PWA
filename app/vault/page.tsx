    ...
    <div className="space-y-6 pb-20">
        ...
        action={
          isUnlocked ? (
            <div className="flex gap-2">
              <button
                onClick={() => lock()}
                className="flex items-center gap-1.5 px-4 py-2 rounded-[8px] text-xs font-black uppercase tracking-widest text-[var(--color-text)] bg-[var(--color-surfaceHover)] hover:bg-[var(--color-surfaceHover)] border-2 border-[var(--color-border)]  hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all active:translate-x-1 active:translate-y-1"
              >
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 rounded-[8px] text-xs font-black uppercase tracking-widest text-white bg-[var(--color-primary)] hover:bg-violet-500 border-2 border-[var(--color-border)]  hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all active:translate-x-1 active:translate-y-1"
              >
      ...
      {!isUnlocked ? (
        <div className="max-w-md mx-auto pt-10">
          <div className="bg-[var(--color-surface)] border-2 border-[var(--color-border)] rounded-[16px]  p-8 text-center relative">
            <div className="w-20 h-20 bg-[var(--color-primary-glow)] border-2 border-[var(--color-border)]  rounded-[12px] flex items-center justify-center mx-auto mb-6">
              ...
              {!hasSetupPin ? (
                ...
                <div className="space-y-6">
                  <button
                    ...
                    className="w-full bg-[var(--color-primary)] hover:translate-x-0.5 hover:translate-y-0.5 hover: active:translate-x-1 active:translate-y-1 active:shadow-none text-white font-black uppercase tracking-widest text-sm rounded-[12px] py-4 border-2 border-[var(--color-border)]  transition-all disabled:opacity-50"
                  >
                  ...
                  <form onSubmit={handlePinAction} className="flex flex-col sm:flex-row gap-3">
                    <input
                      ...
                      required
                    />
                    <button type="submit" disabled={isProcessing || !pinInput} className="bg-black hover:translate-x-0.5 hover:translate-y-0.5 hover: active:translate-x-1 active:translate-y-1 active:shadow-none text-white py-3 sm:px-6 rounded-[12px] font-black uppercase tracking-widest text-xs border-2 border-[var(--color-border)]  transition-all">
                      Save
                    </button>
                  </form>
                </div>
        ...
        <div className="space-y-4">
          ...
          {entries.length === 0 ? (
            <div className="text-center py-16 px-4 border-2 border-dashed border-[var(--color-border)] bg-[var(--color-surface)] rounded-[16px]">
              <div className="w-16 h-16 bg-[var(--color-surfaceHover)] border-2 border-[var(--color-border)] rounded-[12px] flex items-center justify-center mx-auto mb-4">
            ...
            <div className="space-y-3">
              {entries.map(entry => (
                ...
                >
                  <div className="bg-[var(--color-surface)] border-2 border-[var(--color-border)] rounded-[16px]  px-5 py-4 flex items-center justify-between w-full">
                    <div>
                    ...
                    <button
                      ...
                      className="p-2.5 bg-[var(--color-surface)] hover:bg-[var(--color-primary)] hover:text-white border-2 border-[var(--color-border)] rounded-[10px]  hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all active:translate-x-1 active:translate-y-1 text-[var(--color-text)]"
                      title="Reveal secret"
                    >
      ...
      <AdaptiveOverlay isOpen={!!viewingEntry} onClose={() => setViewingEntry(null)} title={viewingEntry?.title || "Secret"}>
        <div className="space-y-4">
          <div className="bg-[var(--color-surfaceHover)] border-2 border-[var(--color-border)] shadow-[inset_0px_2px_4px_rgba(0,0,0,0.05)] rounded-[12px] p-4 overflow-x-auto">
          ...
          <button
            ...
            className="w-full bg-[var(--color-primary)] hover:translate-x-0.5 hover:translate-y-0.5 hover: active:translate-x-1 active:translate-y-1 active:shadow-none text-white font-black uppercase tracking-widest text-sm rounded-[12px] py-4 border-2 border-[var(--color-border)]  transition-all"
          >
            Copy to Clipboard
          </button>
        </div>
